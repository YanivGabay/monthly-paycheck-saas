@echo off
REM OAuth Configuration Test Script for Windows
REM This script runs specific tests to verify Google OAuth setup

echo 🔍 Testing Google OAuth Configuration...
echo ======================================

REM Run OAuth configuration tests specifically (lightweight setup)
